...
create database [Production Inventory]
...
IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID('dbo.inventory_production_with_issues') AND name = 'InvID')
BEGIN
...
LEFT JOIN dbo.inventory_production_with_issues i 
